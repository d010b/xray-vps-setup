# xray-vps-setup
Скрипт установки чистого xray с сайтом, защищенным паролем.  MARZBAN не полностью совместимая панель c xhttp - генерирует в конфигурации XHTTP Extra несовместимые с некоторыми популярными клиентами. При использовании Marzban нужно подбирать клиента.
...
- Установит Xray/Marzban на ваш выбор. Страница (https://github.com/Jolymmiles/confluence-marzban-home)
...
```
- Добавление, просмотр и удаление клиентов, qr код. Когда marzban не нужен.
```bash
