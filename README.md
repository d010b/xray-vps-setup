# xray-vps-setup
VLESS с доменом. XHttp?   MARZBAN не полностью совместимая панель c xhttp - генерирует в конфигурации XHTTP Extra несовместимые с некоторыми популярными клиентами. При использовании Marzban нужно подбирать клиента.
